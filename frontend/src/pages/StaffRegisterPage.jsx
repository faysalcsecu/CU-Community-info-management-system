...
function StaffRegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:3001/register/staff', formDataWithImage, {
                headers: {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="STF_ID" value={formData.STF_ID} onChange={handleChange} required />
                </div>

                <div className="mb-3">
                    <label className="form-label">Name:</label>
                    <input type="text" className="form-control" name="STF_Name" value={formData.STF_Name} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Email:</label>
                    <input type="email" className="form-control" name="STF_Gmail" value={formData.STF_Gmail} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Contact:</label>
                    <input type="text" className="form-control" name="STF_Contact" value={formData.STF_Contact} onChange={handleChange} required />
                </div>

                {/* Other form fields */}
                <div className="mb-3">
                    <label className="form-label">Department:</label>
                    <select className="form-select" name="Dept_ID" value={formData.Dept_ID} onChange={handleChange} required>
                ...
                <div className="mb-3">
                    ...
                    <select className="form-select" name="SC_ID" value={formData.SC_ID} onChange={handleChange} required>
