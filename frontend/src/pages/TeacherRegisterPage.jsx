...
function TeacherRegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:3001/register/teacher', formDataWithImage, {
                headers: {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="T_ID" value={formData.T_ID} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Name:</label>
                    <input type="text" className="form-control" name="T_Name" value={formData.T_Name} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Email:</label>
                    <input type="email" className="form-control" name="T_Gmail" value={formData.T_Gmail} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Contact:</label>
                    <input type="text" className="form-control" name="T_Contact" value={formData.T_Contact} onChange={handleChange} required />
                </div>
                {/* Other form fields */}
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <select className="form-select" name="C_ID" value={formData.C_ID} onChange={handleChange} required>
