...
//     useEffect(() => {
//         // Fetch student data based on studentId when component mounts
...
//         e.preventDefault();
//         try {
//             await axios.put(`http://localhost:3001/student/${studentId}`, studentData);
//             alert("Student updated successfully");
//             onClose(); // Close the update form modal or navigate back
//         } catch (error) {
