...
function StudentRegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('http://localhost:3001/register/student', formDataWithImage, {
                headers: {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="ST_ID" value={formData.ST_ID} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Name:</label>
                    <input type="text" className="form-control" name="ST_Name" value={formData.ST_Name} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Email:</label>
                    <input type="email" className="form-control" name="ST_Gmail" value={formData.ST_Gmail} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Contact:</label>
                    <input type="text" className="form-control" name="ST_Contact" value={formData.ST_Contact} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Batch:</label>
                    <input type="text" className="form-control" name="ST_Batch" value={formData.ST_Batch} onChange={handleChange} required />
                </div>
                <div className="mb-3">
                    <label className="form-label">Department:</label>
                    <select className="form-control" name="Dept_ID" value={formData.Dept_ID} onChange={handleChange} required>
